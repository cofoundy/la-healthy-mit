      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="scroll-animate">
          <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-full px-5 py-2 mb-8">
            ...
            <span className="text-beige text-sm font-medium">Pedido rápido y fácil</span>
          </div>
          ...
          <p className="mt-6 text-lg sm:text-xl text-white/80 max-w-2xl mx-auto leading-relaxed">
            Haz tu pedido directamente por WhatsApp y recibe carnes frescas de
            crianza libre en la puerta de tu casa.
          </p>
          ...
          <a
            ...
            className="mt-10 inline-flex items-center gap-3 bg-white text-green-dark px-10 py-5 rounded-full text-lg font-bold hover:bg-beige-light transition-all hover:scale-105 shadow-xl"
          >
