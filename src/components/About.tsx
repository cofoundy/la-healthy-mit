        ...
        <div className="grid md:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="scroll-animate-left relative">
            <div className="relative rounded-2xl overflow-hidden shadow-xl">
              <img
                src={img("/images/about-food.webp")}
                alt="Pollo de crianza libre La Healthy Mit"
                className="w-full h-[350px] sm:h-[450px] object-cover"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-green-dark/20 to-transparent" />
            </div>
            {/* Floating badge */}
            <div className="absolute -bottom-6 right-4 sm:right-8 bg-white rounded-xl shadow-lg p-4 float-animate">
          ...
          <div className="scroll-animate-right">
            ...
            <p className="mt-6 text-text-mid text-lg leading-relaxed">
            ...
            <div className="mt-10 grid grid-cols-3 gap-6">
              <div className="text-center p-4 rounded-xl bg-beige">
              ...
              <div className="text-center p-4 rounded-xl bg-beige">
                <div className="flex justify-center">
                  <svg className="w-7 h-7 sm:w-8 sm:h-8 text-green-dark" fill="currentColor" viewBox="0 0 24 24">
